...
test_cars = [
    ...
    ('Mercedes Glb 7 Seater', 'Automatic'),
    ('Ford Galaxy', 'Automatic'),
    ('Ford Tourneo', 'Automatic'),
    ('Volkswagen Multivan', 'Automatic'),
    ('Mercedes V Class', 'Automatic'),
    ('Peugeot 5008', 'Automatic'),
    ('Renault Grand Scenic', 'Automatic'),
    ('Citroen Grand Picasso', 'Automatic'),
...
expected_groups = {
    ...
    'mercedes glb 7 seater': 'M2',
    'ford galaxy': 'M2',
    'ford tourneo': 'M2',
    'volkswagen multivan': 'M2',
    'mercedes v class': 'M2',
    'peugeot 5008': 'M2',
    'renault grand scenic': 'M2',
    'citroen grand picasso': 'M2',
    'skoda kodiaq': 'M2',
